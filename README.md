...
| `lib/services/taskbar_integration_service.dart` | Seven desktop destinations, single-instance handover, and the thumbnail toolbar, MPRIS, and notification bridges. |
