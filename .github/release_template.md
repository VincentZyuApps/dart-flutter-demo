...
>
> 📦 **Windows Store MSIX**: The x64 MSIX is an unsigned Partner Center submission package, not a sideload installer. For normal installation, use the setup EXE or portable ZIP.
>
> 📦 **Flatpak**: Install the versioned side-load bundle with `flatpak install --user __BASE_URL__/dart-flutter-demo-linux-x64-v__VERSION__.flatpak`. To follow signed `stable` updates instead, install the fixed [Flatpak reference](https://vincentzyuapps.github.io/flatpak-repo/dart-flutter-demo.flatpakref).
>
