...
TaskbarIntegrationVincentzyuPlugin::TaskbarIntegrationVincentzyuPlugin(
    flutter::PluginRegistrarWindows* registrar)
    : registrar_(registrar), sink_slot_(std::make_shared<EventSinkSlot>()) {
  TrySetAppUserModelId();
  auto method_channel =
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          registrar->messenger(), "taskbar_integration_vincentzyu/methods",
  ...
  auto event_channel =
      std::make_unique<flutter::EventChannel<flutter::EncodableValue>>(
          registrar->messenger(), "taskbar_integration_vincentzyu/events",
          &flutter::StandardMethodCodec::GetInstance());
...
void TaskbarIntegrationVincentzyuPlugin::RegisterWithRegistrar(
    flutter::PluginRegistrarWindows* registrar) {
  registrar->AddPlugin(
      std::make_unique<TaskbarIntegrationVincentzyuPlugin>(registrar));
}

void TaskbarIntegrationVincentzyuPlugin::HandleMethodCall(
...
bool TaskbarIntegrationVincentzyuPlugin::TryClaimSingleInstance() {
  if (instance_mutex_ != nullptr) {
    return true;
  }
...
void TaskbarIntegrationVincentzyuPlugin::EnsureSinkWindow() {
  if (sink_window_ != nullptr) {
    return;
  }
  WNDCLASSEXW window_class = {};
  window_class.cbSize = sizeof(WNDCLASSEXW);
  window_class.lpfnWndProc = &TaskbarIntegrationVincentzyuPlugin::SinkWindowProc;
...
void TaskbarIntegrationVincentzyuPlugin::HandleSinkCopyData(
...
HWND TaskbarIntegrationVincentzyuPlugin::FlutterWindowHandle() {
...
bool TaskbarIntegrationVincentzyuPlugin::ApplyThumbnailToolbar(
    const flutter::EncodableList& buttons,
...
std::optional<LRESULT> TaskbarIntegrationVincentzyuPlugin::HandleWindowProc(
    HWND window,
    UINT message,
    WPARAM wparam,
    LPARAM lparam) {
...
void TaskbarIntegrationVincentzyuPlugin::EmitEvent(flutter::EncodableMap event) {
