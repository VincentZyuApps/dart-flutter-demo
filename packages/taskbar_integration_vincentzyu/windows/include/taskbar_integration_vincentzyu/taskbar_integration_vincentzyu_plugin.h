#ifndef FLUTTER_PLUGIN_TASKBAR_INTEGRATION_VINCENTZYU_PLUGIN_H_
#define FLUTTER_PLUGIN_TASKBAR_INTEGRATION_VINCENTZYU_PLUGIN_H_
...
class TaskbarIntegrationVincentzyuPlugin : public flutter::Plugin {
 public:
  static void RegisterWithRegistrar(flutter::PluginRegistrarWindows* registrar);

  explicit TaskbarIntegrationVincentzyuPlugin(
      flutter::PluginRegistrarWindows* registrar);
  ~TaskbarIntegrationVincentzyuPlugin() override;

  TaskbarIntegrationVincentzyuPlugin(
      const TaskbarIntegrationVincentzyuPlugin&) = delete;
  TaskbarIntegrationVincentzyuPlugin& operator=(
      const TaskbarIntegrationVincentzyuPlugin&) = delete;
...
#endif  // FLUTTER_PLUGIN_TASKBAR_INTEGRATION_VINCENTZYU_PLUGIN_H_
